...
class BuildKnowledge {
  List<Knowledge> knowledgeList = [
    ...
    Knowledge(
      ...
      description:
          "MACD (Moving Average Convergence Divergence)  คือ ตัวชี้วัดที่บอกทิศทางแนวโน้มของราคาหุ้น (Trend)  เป็นเครื่องมือที่มีแนวคิดจากเส้นค่าเฉลี่ยเคลื่อนที่ (Moving Average) 2 เส้นที่มีค่าแตกต่างกัน โดยลักษณะเส้นเป็นแบบ Exponential เรียกอีกชื่อหนึ่งว่า Exponential Moving Average (EMA) หรือจะพูดอีกนัยหนึ่งว่า MACD คือ ระยะห่างระหว่างเส้นค่าเฉลี่ยเคลื่อนที่ 2 เส้น และสามารถใช้การเคลื่อนที่ของ MACD กับ Signal line เพื่อจับจังหวะในการซื้อขายหุ้น\n\nวิธีการอ่านค่า:\nMACD > Signal line หรือ เส้น MACD ตัดขึ้นไปอยู่เหนือ Signal line หมายความว่า ราคาหุ้นมีแนวโน้มสูงขึ้น หรือส่งสัญญาณแนวโน้มขาขึ้น เป็นจังหวะในการเข้าซื้อ เรียกว่า “Bullish MACD”\nMACD < Signal line หรือ เส้น MACD ตัดลงมาอยู่ใต้เส้น Signal line หมายความว่า ราคาหุ้นมีแนวโน้มลดลง หรือส่งสัญญาณแนวโน้มขาลง เป็นการเตือนว่าควรขายหุ้นออก เรียกว่า “Bearish MACD”\n\nTips:\nBullish MACD คือ เกิดจังหวะซื้อ โดยที่เส้น MACD วิ่งขึ้นไปตัดอยู่เหนือ Signal line หมายความว่า ราคามีแนวโน้มที่จะปรับตัวสูงขึ้น บ่งบอกถึงโอกาสที่ดีในการเข้าไปซื้อหุ้น\nBearish MACD คือ เกิดจังหวะขาย โดยเส้น MACD วิ่งลงมาตัดอยู่ใต้ Signal line หมายความว่า ราคามีแนวโน้มปรับตัวลดลง เป็นสัญญาณเตือนให้ขายหุ้นออก",
    ),
    Knowledge(
      title: "EMA คืออะไร?",
      image:
