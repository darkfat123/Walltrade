...
// เพิ่มตัวแปร PageController
  ...
  Future<void> getBalance() async {
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        TH_balance = double.parse(th_cash) * USDtoTHB;
  ...
  Future<void> fetchPositionData() async {
    ...
    if (response.statusCode == 200) {
      ...
      US_totalChart = US_Fiat == 0 ? 1 : (US_marketValue / US_Fiat);
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              hideBalance
                                  ? "**** USD (****)"
                                  : "${NumberFormat('#,###.##', 'en_US').format(TH_balance)} บาท",
                              style: TextStyle(
                                fontSize: 30,
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                      ...
                                      fontSize: 12,
                                      color: TH_ProfitChange.toString()
                                              .startsWith("-")
                                          ? Colors.red
                                          : Color(0xFF13B709),
                                    ),
